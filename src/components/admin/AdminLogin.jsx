...
const AdminLogin = ({ onLoginSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://event-backend-new.vercel.app/api/auth/login', {
        method: 'POST',
        headers: {
  ...
  const runSeedScript = async () => {
    try {
      const response = await fetch('https://event-backend-new.vercel.app/api/admin/run-seed', {
        method: 'POST'
      });
